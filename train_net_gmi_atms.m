...
% this is low-reso
upsampledDirName='/storage/cms/youy_lab/youy/super-reso/data_v3_td_ts/atms/ssmis-train/';
residualDirName='/storage/cms/youy_lab/youy/super-reso/data_v3_td_ts/atms/gmi-ssmis-train/';
...
file_net_name=['trainedVDSR-v3-',...
    ...
    'patchesPerImage',num2str(patchesPerImage),'-atms.mat'];

file_info_name=['trainedVDSR-v3-',...
    'epoch',num2str(maxEpochs),'-',...
    'ND',num2str(networkDepth),'-',...
    'patchesPerImage',num2str(patchesPerImage),'-info-atms.mat'];
